...
public class AnalisisDesviacionFacade extends AbstractFacade<AnalisisDesviacion> {
    ...
    public AnalisisDesviacion edit(AnalisisDesviacion anDesv) throws Exception {
        ...
        adDB.setObservacion_causas(anDesv.getObservacion_causas());
        adDB.setSeguimiento(anDesv.getSeguimiento());
        adDB.setGestor(anDesv.getGestor());
        adDB.setIdCausasSelect(anDesv.getIdCausasSelect());
        adDB.setMatrizPeligro(anDesv.getMatrizPeligro());
