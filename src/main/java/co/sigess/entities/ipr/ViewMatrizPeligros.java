 ...
 */
@Entity
@Table(name = "view_matriz_peligros", schema = "ipr")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ViewMatrizPeligros.findAll", query = "SELECT vmp FROM ViewMatrizPeligros vmp")})
public class ViewMatrizPeligros implements Serializable{
